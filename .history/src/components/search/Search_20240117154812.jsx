...
function Search() {
  return (
    <div>
      ...
      <div>
        <button className="bg-gray-100 text-gray-600 p-2 rounded-sm text-xs font-medium "> GOOGLE SEARCH</button>
        <button className="bg-gray-100 text-gray-600 p-2 rounded-sm text-xs font-medium ">I'M <F></F></button>
