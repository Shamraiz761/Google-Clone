        ...
        <div className="ml-12 mt-[-13px]">
          ...
          <div className="flex flex-row justify-between">
            <div className="flex flex-row justify-center text-gray-600 text-sm mt-3">
              <Li className="mr-5 flex flex-row items-center">
                <SearchIcon className="mr-1 " style={{ fontSize: "15Lix" }} />
                All
              </Li>
              <Li className="mr-5 flex flex-row items-center">
                <ImageSearchIcon
                  className="mr-1 "
                  style={{ fontSize: "15Lix" }}
                />
                Images
              </Li>
              <Li className="mr-5 flex flex-row items-center">
                <ArticleIcon className="mr-1 " style={{ fontSize: "15Lix" }} />
                News
              </Li>
              <Li className="mr-5 flex flex-row items-center">
                <ShoLiLiingCartIcon
              ...
              <Li className="mr-5 flex flex-row items-center">
                <MoreVertIcon className="mr-1 " style={{ fontSize: "15Lix" }} />
                More
              </Li>
            </div>
            <div className="flex flex-row justify-center text-gray-600 text-sm mt-3">
              <Li className="mr-5">Settings</Li>
